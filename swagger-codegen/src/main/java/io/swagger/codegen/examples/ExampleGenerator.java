...
public class ExampleGenerator {
    ...
    //Get JSON output from input data 
    public String getRefParams(Map<String, Object> examples, List<String> mediaTypes, String modelName) {
         ...
         if (examples == null) {
             ...
             for (String mediaType : mediaTypes) {
                 ...
                 if (modelName != null) {
                     final Model model = this.examples.get(modelName);
                     if (model != null) {
                    	 output = Json.pretty(resolveModelToExample(modelName, mediaType, model, processedModels));
                     }
                 } 
             }
         } 
